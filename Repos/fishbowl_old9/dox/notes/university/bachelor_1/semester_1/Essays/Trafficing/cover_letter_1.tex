...
\begin{center}
\large\bf Emergency Action Request: Epedemic of Sexual Exploitation of Minors \\ % Your name
%\vspace{20pt} \hrule height 1pt % If you would like a horizontal line separating the name from the address, uncomment the line to the left of this text
Pittsburgh City Hall \\ CC: Gender Equality Commission \\ CC: Police, Fire, EMS % Your address and phone number
\end{center}
\vfill
