...
\fancyhf{}
\fancyfoot[C]{\thepage}
\fancyfoot[LE,RO]{MAT-253-AC01: Linear Algebra}
...
{\centering
	...
	{\scshape\LARGE Lecture Notes \par}\vspace{1cm}{\huge\bfseries Linear Algebra\par}
	\vspace{.5cm}{\large Fall 2020  \par}\vspace{.5cm}{\Large\itshape Jasper Runco \par}
	\vfill Instructed by: \par{\large \itshape Kathy Kane \par}}
