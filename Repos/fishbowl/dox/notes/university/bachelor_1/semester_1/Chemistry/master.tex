...
{\centering
	...
	{\scshape\LARGE Lecture Notes \par}\vspace{1cm}{\huge\bfseries Chemistry \par}
	\vspace{.5cm}{\large Spring 2020 \par}\vspace{.5cm}{\Large\itshape Jasper Runco \par}
	\vfill Instructed by \par{\large \itshape Catherine Drennan \par} Assisted by \par
